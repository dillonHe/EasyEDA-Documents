...
提示：立创EDA不支持导出原理图库文件，如果你想导出原理图库文件，则你需要将你所需的原理图库文件全部放在一个原理图后，再导出AD格式的原理图，然后在AD中提取。
...
提示：立创EDA不支持导出PCB库文件，如果你想导出PCB库文件，则你需要将你所需的PCB库文件全部放在一个原理图后，再导出AD格式的PCB，然后在AD中提取。
